...
//   const imgDealerDetails = ref('/Dealer_details.png')
  ...
  const imgAlarmStatistics = ref('/overview_equipment-click.png')
  ...
  const imgSystemsManagement = ref('/wax_material.png')
  ...
  const menuClick = (event: MouseEvent) => {
    ...
    if (menuText === '设备信息概览') {
      imgAlarmStatistics.value = '/overview_equipment-click.png'
      imgFaultAlarm.value = '/material_information_first.png'
    } else if (menuText === '蜡材信息概览') {
      imgAlarmStatistics.value = '/overview_equipment.png'
      imgFaultAlarm.value = '/material_information_first-click.png'
    }
  }
  ...
  onMounted(async () => {
    ...
    if (route.path === '/equipment/materialInformation') {
      imgAlarmStatistics.value = '/overview_equipment.png'
      imgFaultAlarm.value = '/material_information_first-click.png'
    } else if (route.path === '/equipment') {
      imgAlarmStatistics.value = '/overview_equipment-click.png'
      imgFaultAlarm.value = '/material_information_first.png'
    } else {
      activeMenuItem.value = '/equipment'
    }
  });
      ...
      <el-container>
        <el-aside width="210px">
            ...
            >
              ...
              <el-menu-item  class="clcustomerHierarchy" index="/equipment">
                <el-image :src="imgAlarmStatistics" class="systemsManagement" />
                <span class="endCustomer">设备信息概览</span>
              </el-menu-item>
              <el-menu-item class="clcustomerHierarchy" index="/equipment/materialInformation">
                <el-image :src="imgFaultAlarm" class="systemsManagement" />
                <span class="endCustomer">蜡材信息概览</span>
              </el-menu-item>
            </el-menu>
        </el-aside>
