<!-- <script lang="ts" setup>
  ...
  const imgEndCustomer = ref('/end_customer_management.png')

  const imgEndCustomerDetails = ref('/end_customer_details.png')

  const imgDealerManagement = ref('/dealer_management.png')

  const imgDealerDetails = ref('/Dealer_details.png')

  const imgCustomerHierarchy = ref('/Customer_hierarchy.png')
</script>
      ...
      <el-header>
        <div class="left flex items-center" @click="navigateTo('/')">
          ...
          <div class="content flex items-center">
            <span class="wax">Waxcloud</span>
            <span class="iemp">设备综合管理平台</span>
          </div>
        </div>
        <div class="middle">
        ...
        <div class="right flex">
          ...
          <div class="flex">
            ...
            <el-icon class="el-icon--right elCare" :size="22">
              <CaretBottom />
            </el-icon>
          </div>
        </div>
      ...
      <el-container>
        <el-aside width="200px">
            <el-menu
              ...
              router
            >
              <div class="client-title flex items-center">客户管理</div>
              <el-sub-menu index="/client" class="menuBox">
                <template #title>
                  <div @click="navigateTo('/client')">
                    <el-icon>
                      <el-image :src="imgEndCustomer" />
                    </el-icon>
                    <span class="endCustomer">终端客户管理</span>
                  </div>
                </template>
                <el-menu-item class="endCustomerDetails" index="/client/endCustomerDetails">
                  <template #title>
                    <el-icon>
                      <el-image :src="imgEndCustomerDetails" />  
                    </el-icon>
                    <span class="endCustomer">终端客户详情</span>
                  </template>
                </el-menu-item>
              </el-sub-menu>
              <el-sub-menu index="/client/dealerManagement" class="menuBox">
                <template #title>
                  <div @click="navigateTo('/client/dealerManagement')">
                    <el-icon>
                      <el-image :src="imgDealerManagement" />
                    </el-icon>
                    <span class="endCustomer">经销商管理</span>
                  </div>
                </template>
                <el-menu-item class="endCustomerDetails" index="/client/dealerDetails">
                  <template #title>
                    <el-icon>
                      <el-image :src="imgDealerDetails" />
                    </el-icon>
                    <span class="endCustomer">经销商详情</span>
                  </template>
                </el-menu-item>
              </el-sub-menu>
              <el-menu-item class="clcustomerHierarchy" index="/client/customerHierarchy">
                <el-icon>
                  <el-image :src="imgCustomerHierarchy" />
                </el-icon>
                <span class="endCustomer">客户层级结构</span>
              </el-menu-item>
            </el-menu>
        </el-aside>
        <el-main>
...
//   const imgDealerDetails = ref('/Dealer_details.png')
  ...
  const imgAlarmStatistics = ref('/end_customer_management-click.png')

  const imgFaultAlarm = ref('/dealer_management_first.png')

  const imgCargoFleeingAlarm = ref('/message_center_first.png')
  ...
  const imgSystemsManagement = ref('/customer_management.png')
  ...
  const menuClick = (event: MouseEvent) => {
    ...
    if (menuText === '终端客户管理') {
      imgAlarmStatistics.value = '/end_customer_management-click.png'
      imgFaultAlarm.value = '/dealer_management_first.png'
      imgCargoFleeingAlarm.value = '/message_center_first.png'
    } else if (menuText === '经销商管理') {
      imgAlarmStatistics.value = '/end_customer_management_first.png'
      imgFaultAlarm.value = '/dealer_management-click.png'
      imgCargoFleeingAlarm.value = '/message_center_first.png'
    } else if (menuText === '客户层级结构') {
      imgAlarmStatistics.value = '/end_customer_management_first.png'
      imgFaultAlarm.value = '/dealer_management_first.png'
      imgCargoFleeingAlarm.value = '/message_center_first-click.png'
    }
  }
  ...
  onMounted(async () => {
    ...
    if (route.path === '/client/customerHierarchy') {
      imgAlarmStatistics.value = '/end_customer_management_first.png'
      imgFaultAlarm.value = '/dealer_management_first.png'
      imgCargoFleeingAlarm.value = '/message_center_first-click.png'
    } else if (route.path === '/client/dealerManagement') {
      imgAlarmStatistics.value = '/end_customer_management_first.png'
      imgFaultAlarm.value = '/dealer_management-click.png'
      imgCargoFleeingAlarm.value = '/message_center_first.png'
      ...
      <el-container>
        <el-aside width="200px">
            ...
            >
              ...
              <el-menu-item  class="clcustomerHierarchy" index="/client">
                <el-image :src="imgAlarmStatistics" class="systemsManagement" />
                <span class="endCustomer">终端客户管理</span>
              </el-menu-item>
              <el-menu-item class="clcustomerHierarchy" index="/client/dealerManagement">
