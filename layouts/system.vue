...
//   const imgDealerDetails = ref('/Dealer_details.png')
  ...
  const imgAlarmStatistics = ref('/account_management-Click.png')

  const imgFaultAlarm = ref('/alarm_rule.png')

  const imgCargoFleeingAlarm = ref('/message_center.png')
  ...
  const imgSystemsManagement = ref('/systems_management.png')
  ...
  const menuClick = (event: MouseEvent) => {
    ...
    if (menuText === '账户管理') {
      imgAlarmStatistics.value = '/account_management-Click.png'
      imgFaultAlarm.value = '/alarm_rule.png'
      imgCargoFleeingAlarm.value = '/message_center.png'
    } else if (menuText === '告警规则') {
      imgAlarmStatistics.value = '/account_management.png'
      imgFaultAlarm.value = '/alarm_rules-Click.png'
      imgCargoFleeingAlarm.value = '/message_center.png'
    } else if (menuText === '消息中心') {
      imgAlarmStatistics.value = '/account_management.png'
      imgFaultAlarm.value = '/alarm_rule.png'
      imgCargoFleeingAlarm.value = '/message_center-Click.png'
    }
  }
      ...
      <el-container>
        <el-aside width="200px">
            ...
            >
              ...
              <el-menu-item  class="clcustomerHierarchy" index="/system">
                <el-image :src="imgAlarmStatistics" class="systemsManagement" />
                <span class="endCustomer">账户管理</span>
              </el-menu-item>
              <el-menu-item class="clcustomerHierarchy" index="/system/alarmRule">
                <el-image :src="imgFaultAlarm" class="systemsManagement" />
                <span class="endCustomer">告警规则</span>
              </el-menu-item>
              <el-menu-item class="clcustomerHierarchy" index="/system/messageCenter">
                <el-image :src="imgCargoFleeingAlarm" class="systemsManagement" />
                <span class="endCustomer">消息中心</span>
              </el-menu-item>
            </el-menu>
        </el-aside>
