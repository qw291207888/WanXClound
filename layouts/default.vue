...
//   const imgDealerDetails = ref('/Dealer_details.png')
  ...
  const imgAlarmStatistics = ref('/working_table_box.png')
  ...
  const imgSystemsManagement = ref('/working_table.png')
      ...
      <el-container>
        <el-aside width="200px">
            ...
            >
              ...
              <el-menu-item class="clcustomerHierarchy" index="/">
                <el-image :src="imgAlarmStatistics" class="systemsManagement" />
                <span class="endCustomer">工作台</span>
              </el-menu-item>
