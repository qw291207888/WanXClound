...
<template>
  <div class="accountManagement flex flex-col">
    ...
    <div class="formBox flex-1">
      ...
      <div class="search-box flex justify-between items-center">
        <div class="flex flex-wrap gap-10 search-jsk">
          ...
          <div class="flex items-center">
            ...
            <el-select v-model="userStatus" placeholder="全部" class="userStatus">
              <el-option
      ...
      <el-table :data="paginatedData" border max-height="200" style="width: 100%;">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column prop="name" label="用户名称" width="165" align="center">
          <template #default="{ row }">
            {{ row.name || '—' }}
          </template>
        </el-table-column>
        <el-table-column prop="email" label="登陆账号" width="220" align="center">
          <template #default="{ row }">
            {{ row.email || '—' }}
          </template>
        </el-table-column>
        <el-table-column prop="phone" label="绑定电话号" width="165" align="center">
          <template #default="{ row }">
            {{ row.phone || '—' }}
          </template>
        </el-table-column>
        <el-table-column prop="company" label="所属组织/部门" width="220" align="center">
          <template #default="{ row }">
            {{ row.company || '—' }}
          </template>
        </el-table-column>
        <el-table-column prop="role_id" label="角色权限" width="165" align="center">
          <template #default="{ row }">
            {{ row.role_id || '—' }}
          </template>
        </el-table-column>
        <el-table-column prop="status" label="用户状态" width="165" align="center">
          <template #default="{ row }">
            {{ row.status || '—' }}
          </template>
        </el-table-column>
