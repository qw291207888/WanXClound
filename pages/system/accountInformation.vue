  ...
  <div class="accountManagement flex flex-col">
    ...
    <div class="formBox flex-1">
      <div class="formBox-title">
        <span style="margin-right: 20px;">添加账户信息</span>
      ...
      <el-form :model="form" :rules="rules" label-width="auto" style="max-width: 600px" ref="formRef">
        ...
        </el-form-item><el-form-item label="绑定电话">
          <el-input v-model="form.bindingTelephone" placeholder="请输入绑定电话" />
        </el-form-item>
        <el-form-item label="洲区/国家">
          <div class="flex coutry-box">
            <el-select v-model="form.zhouQu" placeholder="请选择洲区">
              <el-option label="请选择洲区" value="请选择洲区" />
              <el-option label="亚太区" value="亚太区" />
              <el-option label="美洲区" value="美洲区" />
              <el-option label="欧洲区" value="欧洲区" />
              <el-option label="非洲区" value="非洲区" />
            </el-select>
            <el-select v-model="form.country" placeholder="请选择国家或地区">
              <el-option label="请选择国家或地区" value="请选择国家或地区" />
        ...
        <el-form-item label="角色权限">
          <el-select v-model="form.rolePermissions" placeholder="请选择">
