<script lang="ts" setup>
  ...
  watch(value2, (newValue, oldValue) => {
    console.log(`value2 changed from ${oldValue} to ${newValue}`);
...
<template>
  <div class="customerDetails">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>设备故障告警</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="customerDetails-box">设备故障记录</div>
        ...
        <div class="flex flex-col justify-center gap-5">
          <div class="flex items-center">
            <div v-if="containsDeviceModel">
              ...
              <el-select v-model="selectedModel" placeholder="请选择" style="width: 240px" @change="handleCountryChange">
                <el-option
